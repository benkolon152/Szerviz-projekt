...
<div style="align-items: center; justify-content: center; display: flex; height: 100vh;">
    <div style="background: rgba(0, 0, 0, 0.5); min-width: 300px; min-height: 300px; align-items: center; justify-content: center; display: flex; flex-direction: column; padding: 20px; border-radius: 10px;">
      ...
      <form style="display: flex; flex-direction: column;">
        <input type="text" placeholder="Username" style="border: none; padding: 10px; border-radius: 5px;" />
        <input type="password" placeholder="Password" style="border: none; padding: 10px; border-radius: 5px; margin: 10px 0;" />
        ...
        <p>Don't have an account? <a href="/logs" id="reg">Register</a> here.</p>
      </form>
    </div>
</div>